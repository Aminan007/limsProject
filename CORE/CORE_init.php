...
$app_const = array(
    ...
    "CORE_TMPDIR_MAXAGE" => array(
        "val" => "2",
        "descr" => N_("core_tmpdir_maxage") ,
        "user" => "N",
        "global" => "Y"
    ) ,
    "CORE_TMPDOC_MAXAGE" => array(
        "val" => "1",
        "descr" => N_("core_tmpdoc_maxage") ,
        "user" => "N",
        "global" => "Y"
    ) ,
    ...
    "CORE_SESSION_BYTE_LENGTH" => array(
        "val" => "16",
        "descr" => N_("core_session_byte_length") ,
        "user" => "N",
        "global" => "Y"
    ) ,
    ...
    "CORE_NOTIFY_SENDMAIL" => array(
        "val" => "always",
        "descr" => N_("Show a notification when a mail is sent") ,
        "kind" => "enum(always|errors only|never)",
        "user" => "N",
        "global" => "Y"
    ) ,
    // WSH error mail
    "CORE_WSH_MAILTO" => array(
        "val" => "",
        "descr" => N_("WSH error mail recipients (comma-separated list of mail addresses)") ,
        "user" => "N",
        "global" => "Y"
    ) ,
    "CORE_WSH_MAILSUBJECT" => array(
        "val" => "[%h](%c) Script error: %m",
